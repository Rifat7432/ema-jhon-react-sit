    ...
    return (
        <div className=' rounded-lg'>
            <div className='bg-red-50  text-slate-900 '>
              ...
              <div className='mb-10'>
              <button onClick={clear} className="btn btn-error mx-auto my-5 w-3/4">Clear Cart <span className='ml-3'><FontAwesomeIcon icon={faTrashAlt}/></span></button>
              <Link to='/'>
              <button className="btn btn-warning mx-auto  my-5 mb-10 w-3/4">Proceed Checkout <span className='ml-3 text-slate-300'><FontAwesomeIcon icon={faWallet}/></span></button>
              </Link>
              </div>
        </div>
        </div>
